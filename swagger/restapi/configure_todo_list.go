...
import (
	...
	"github.com/jzhang/golearn/swagger/restapi/operations"
	"github.com/jzhang/golearn/swagger/restapi/operations/todos"
)

// This file is safe to edit. Once it exists it will not be overwritten

//go:generate swagger generate server --target .. --name TodoList --spec ../todolist.yaml
